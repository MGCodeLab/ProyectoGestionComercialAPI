...
public class MarcasProductoController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Crear([FromBody] CrearMarcaProductoDto dto)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Actualizar(int id, [FromBody] ActualizarMarcaProductoDto dto)
    {
